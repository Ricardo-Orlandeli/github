...
if __name__ == "__main__":
    ...
    # Gerar dataset pequeno (100 tuplas)
    gerar_dataset(num_projetos=100, output_dir="../dataset/small_training")
    # Gerar dataset grande (1000 tuplas)
    gerar_dataset(num_projetos=1000, output_dir="../dataset/large_training")
